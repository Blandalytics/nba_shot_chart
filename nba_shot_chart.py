...
def plotly_chart(points_agg):    
    ...
    fig.update_xaxes(range=[bottom_lim, make_lim],showgrid=False, showline=True, zeroline=False)
    fig.update_yaxes(range=[bottom_lim, qual_lim],showgrid=False, showline=True, zeroline=False)
