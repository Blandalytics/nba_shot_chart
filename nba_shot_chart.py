...
def shot_summary(player_id,game_date=game_date, season_long=season_long):
    ...
    ax2.text(1,max_val*1.15,f'Pts via Shots: {shot_points:.0f}',ha='center',fontsize=14)
    ax2.text(4,max_val*1.15,f'Pts via Free Throws: {ft_points:.0f}',ha='center',fontsize=14)
